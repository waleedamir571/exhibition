                            ...
                            <div class="row gx-5 align-items-center">
                                <div class="col-md-6 mb-sm-30 ">
                                    ...
                                    <p class=" text-uppercase mb-3 head-text"> <span class="wow fadeInRight"
                                            data-wow-delay=".2s">Electronics</span></p>
                                ...
                                <div class="col-md-6 mb-sm-30 text-center">
                                    ...
                                    <img src="images/electronics/head.png" alt="">
                                </div>
    ...
    <div class="container position-relative z1000">
        <div class="row">
            <div class="col-md-12 text-center wow fadeInUp">
                <p class="about-us relax2 montserrat"> <img src="images/home/Line.png" alt=""> Electronics Trade Shows
                    <img src="images/home/Line.png" alt="">
                </p>
                <br>
                <p class="head-text1">Exhibiting at an electronics trade show is essential for businesses launching new
                    gadgets, semiconductors, or smart home solutions.
                </p>
        ...
        <div class="row align-items-center">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            ...
                            <h2 class="text-uppercase wow fadeInRight relax3 montserrat animated animated"
                                ...
                                Top  <span style="color: #514CA0;">Electronics</span>
                                Trade Shows:
                            </h2>
                        </div>
                        <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s"><span class="about-us">
                                🔹 Electronica</span> – The leading trade fair for electronic components and systems</p>
                        <br>
                        <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s"><span class="about-us">🔹
                            IFA Berlin</span> – A global event for consumer electronics and home appliances.</p>
                        <br>
                        <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s"><span class="about-us">🔹
                            Embedded World</span> – A must-attend for embedded systems and IoT applications.
                        </p>
                        <br>
            ...
            <div class="col-md-6 position-relative">
                ...
                <div class="row">
                    ...
                    <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s"> ✅ Launch the latest innovations in consumer and industrial electronics.</p>
                    <br>
                    <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s">✅ Connect with manufacturers, distributors, and retailers.</p>
                    <br>
                    <p class="wow fadeInRight head-text1 animated" data-wow-delay=".4s"> ✅ Get media exposure for your brand.
                    </p>
                    <br>
