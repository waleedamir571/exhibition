    ...
    <div class="container">
        <div class="row pt-50 pb-30">
            <div class="col-md-4">
                <div class="card card1">
                    <div class="img-center">
                        <img class="" src="images/what-we-do/law.png" alt="Card image cap">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card card1">
                    <div class="img-center">
                        <img class="" src="images/what-we-do/chart.png" alt="Card image cap">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card card1">
                    <div class="img-center">
                        <img class="" src="images/what-we-do/eye.png" alt="Card image cap">
                    </div>
                    <div class="card-body">
...
<section id="section-schedule" class="jarallax no-bottom">
    ...
    <div class="container position-relative z1000">
        <div class="row">
            <div class="col-md-12 text-center wow fadeInUp">
                <p class="about-us relax2 montserrat"> <img src="images/home/Line.png" alt=""> Post-show management
                    <img src="images/home/Line.png" alt="">
                </p>
                <br>
                ...
                <div class="col-md-6">
                    ...
                    <h2 class="wow fadeInRight head-text1 animated animated" data-wow-delay=".3s"> <span
                        ...
                        <h2 class="text-uppercase wow fadeInRight relax3 montserrat animated" data-wow-delay=".3s">
                            ...
                            Raise the <span style="color: #514CA0;">bar.</span>
            ...
            <div class="row">
                ...
                <div class="col-md-5 offset-md-1 position-relative" data-jarallax-element="-60">
                    ...
                    <div class="position-relative z1000">
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <p class="wow fadeInRight head-text1" data-wow-delay=".4s">
